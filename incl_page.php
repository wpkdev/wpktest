<?php
	...
	echo '<div class="page-content page-content-box page-content-box-'.$counter.'" vert-'.$position_vertical.' hor-'.$position_horizontal.'  '.$color_scheme.' "><div class="text-wrapper">';
