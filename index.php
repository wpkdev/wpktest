...
endwhile;
	...
	<div class="footer-content text-wrapper">
		...
		<div class="social-links">
			<a href="https://www.facebook.com/sharer/sharer.php?u=http://www.shotofjoy.nl/'.date("l").'/" onclick="_gaq.push(["_trackEvent", "Social media", "Facebook", "Footer"]);" class="btn btn-small btn-facebook js-social-popup" target="_blank"><span class="icon-facebook"></span>Facebook</a>
