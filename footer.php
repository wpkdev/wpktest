...
<div class="social-media-box">
	<ul>
		...
		<li class="mobile-popup"><a href="mailto:?SUBJECT=<?php echo $post_title ?>&BODY=Hi..., ik wil graag dit artikel met je delen: <?php echo urlencode($post_url); ?>" target="_blank" class="icon-mail mobile-popup" >&nbsp;</a></li>
