...
<div class="social-media-box">
	<ul>
		<li class="mobile-popup"><a href="https://www.facebook.com/sharer/sharer.php?u=http://www.shotofjoy.nl/<?php echo date("l"); ?>/" class="icon-facebook js-social-popup " onclick="_gaq.push(['_trackEvent', 'Social media', 'Facebook', 'sidebar']);">&nbsp;</a></li>
