	...
	function gallery_func( $atts ){
	 	extract( shortcode_atts( array(
			...
			foreach ($idArray as &$id) {
	    		...
	    		$output .= '<li '.$class.'><a href="'.get_site_url().'/out?redirect='.$shop_url.' " class="js-gallery"><div class="img-gallery-box"><div class="gallery-btn"><span>Shop it</span></div><img src="'.$src[0].'" width="'.$src[1].'" height="'.$src[2].'"  nopin="nopin" class="js-no-lazy-loading" /></div><div class="gallery-description">
